 // Your web app's Firebase configuration
  ...
  dataBase.collection("turmaA").where("Nome","==","Denya").get().then(snapshot=>{
    snapshot.forEach(doc => {
      let aluno = doc.data();
  ...
  dataBase.collection(TURMA).doc("Aluno4").set({
    Nome:"Luna",
    Idade:"1.5",
    Notas:{
      ["Nota 1"] : 0,
  ...
  dataBase.collection(TURMA).doc("l1Mhccf8QCyfohtt2I9V").update(
    {
    Sobrenome: "Louisa"
  }).then(()=>{
    console.log("Documento alterado com sucesso!");
